      ...
      <div className="mx-auto flex max-w-md flex-col gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Register once, then your conversations are saved under your user profile.</CardDescription>
          </CardHeader>
          <form onSubmit={handleSubmit}>
            ...
            <CardFooter className="flex flex-col gap-3">
              ...
              <p className="text-sm text-slate-500">
                Already registered? <Link className="font-medium text-slate-950 underline" to="/login">Sign in</Link>
              </p>
            </CardFooter>
          </form>
        </Card>
